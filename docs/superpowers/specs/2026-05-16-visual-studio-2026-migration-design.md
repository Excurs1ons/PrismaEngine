...
- **文档类**：`CLAUDE.md`, `docs/MEMO.md`, `docs/ScriptingSystem.md`, `docs/rendering-refactoring-plan.md`, `docs/DeviceConfiguration.md`, `docs/MCP_Test_Report.md`, `sdk/README.md`, `.github/workflows/README.md`
