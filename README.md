...
> Module progress tracked in [MODULE_PROGRESS.md](docs/MODULE_PROGRESS.md). Task priorities in [TODO.md](docs/TODO.md).
...
- [TODO / Roadmap](docs/TODO.md) - Prioritized task list with 4D decision framework
