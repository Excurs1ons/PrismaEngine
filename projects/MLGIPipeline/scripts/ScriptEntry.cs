...
internal static class ScriptEntry
{
    ...
    public static void Bootstrap(IntPtr apiPtr)
    {
        ...
        MLGIPipeline.Generated.ScriptRegistry.RegisterAll();
        ...
        System.Console.WriteLine("[MLGIPipeline] Scripts initialized, CameraController3D active");
    }
