...
public:
    ...
    void Update(bool isPressed) {
        ...
        if (m_action == InputAction::Pressed && isPressed && !m_wasPressed)
            triggered = true;
        else if (m_action == InputAction::Released && !isPressed && m_wasPressed)
            triggered = true;
        else if (m_action == InputAction::Held && isPressed)
            triggered = true;
        if (triggered)
            m_callback();
