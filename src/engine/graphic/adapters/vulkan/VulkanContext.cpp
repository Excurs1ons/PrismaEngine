...
void
VulkanContext::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void VulkanContext::generateMipmaps(VkImage image, VkFormat imageFormat, int32_t texWidth,
