...
struct BoundingBox {
    ...
    BoundingBox() : min(PrismaMath::vec3(0, 0, 0)), max(PrismaMath::vec3(0, 0, 0)) {}
    BoundingBox(const PrismaMath::vec3& minVal, const PrismaMath::vec3& maxVal) : min(minVal), max(maxVal) {}
