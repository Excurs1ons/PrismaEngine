...
public static class Mathf
{
    ...
    /// <summary>计算反正切�?(y/x)�?Returns the angle in radians whose Tan is y/x.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>计算�?10 为底的对数�?Returns the base-10 logarithm of f.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
