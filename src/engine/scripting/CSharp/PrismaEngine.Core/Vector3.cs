...
public struct Vector3 : IEquatable<Vector3>, ISpanFormattable
{
    ...
    /// <summary> 构造一个新的 3D 向量。 Constructs a new 3D vector. </summary>
    public Vector3(float x, float y, float z) { X = x; Y = y; Z = z; }
    /// <summary> 构造一个新的 3D 向量 (Z 为 0)。 Constructs a new 3D vector (Z is 0). </summary>
    ...
    /// <summary> 零向量 (0, 0, 0)。 Zero vector (0, 0, 0). </summary>
    public static readonly Vector3 Zero = new(0, 0, 0);
    /// <summary> 单位向量 (1, 1, 1)。 One vector (1, 1, 1). </summary>
    public static readonly Vector3 One = new(1, 1, 1);
    /// <summary> 上向量 (0, 1, 0)。 Up vector (0, 1, 0). </summary>
    public static readonly Vector3 Up = new(0, 1, 0);
    /// <summary> 下向量 (0, -1, 0)。 Down vector (0, -1, 0). </summary>
    public static readonly Vector3 Down = new(0, -1, 0);
    /// <summary> 左向量 (-1, 0, 0)。 Left vector (-1, 0, 0). </summary>
    public static readonly Vector3 Left = new(-1, 0, 0);
    /// <summary> 右向量 (1, 0, 0)。 Right vector (1, 0, 0). </summary>
    public static readonly Vector3 Right = new(1, 0, 0);
    /// <summary> 前向量 (0, 0, 1)。 Forward vector (0, 0, 1). </summary>
    public static readonly Vector3 Forward = new(0, 0, 1);
    /// <summary> 后向量 (0, 0, -1)。 Back vector (0, 0, -1). </summary>
